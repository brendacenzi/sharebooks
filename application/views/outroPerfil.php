...
<html lang="pt-br">
    <head>
    	<title><?= $info->nm_usuario; ?> | Sharebooks</title>
    	<meta name="description" content="Perfil de outro usuário, livros e pontuação">
    	<?php
    ...
    <body id="index">
        ...
        <main>
            ...
            <div id="cont-perfil">
                ...
                <div id="previa-estante">
                    ...
                    <?php 
                        ...
                        foreach($result->result_array()  as $row) {
                            ...
                            echo "<a href='/index.php/Livro/solicitar/" . $info->cd_usuario . "/" .  $row['cd_livro']  . "'><div class='livro'>";
                            echo "<p>";
                ...
                <div id='ver-estante'>
                    <?php
                        $caminho = '/index.php/Usuario/verEstante/' . $info->cd_usuario;
                        echo "<a href='" . $caminho . "'>>> Ver mais</a>";
                    ?>
                </div>
            </div>
        </main>
