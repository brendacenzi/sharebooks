...
<html lang="pt-br">
    <head>
        <title>
            Estante - 
            <?php foreach($usuario->result_array() as $row) { echo ucfirst($row['nm_usuario']);}?>
            | Sharebooks
        </title>
    	<?php
    ...
    <body>
        ...
        <main class="container2">
            <h1>Estante - <?php foreach($usuario->result_array() as $row) { echo ucfirst($row['nm_usuario']);}?></h1>
            <br>
            <br>
            ...
            <?php 
                ...
                foreach($result->result_array()  as $row) {
                    ...
                    echo "<a href='/index.php/Livro/solicitar/" . $usuarioid . "/" .  $row['cd_livro']  . "'><div class='livro'>";
                    echo "<p>";
